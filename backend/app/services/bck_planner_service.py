...
2. Never emit CREATE_CLAIM for policy information questions.
...
All such questions must be classified as POLICY_QUERY.
...
Output: [{"intent":"POLICY_QUERY","query":"Do I get roadside assistance?"}]

User: Will I get a replacement car?
Output: [{"intent":"POLICY_QUERY","query":"Will I get a replacement car?"}]

User: Is towing included?
Output: [{"intent":"POLICY_QUERY","query":"Is towing included?"}]

User: Will my car be towed?
Output: [{"intent":"POLICY_QUERY","query":"Is towing included?"}]

User: Can I get roadside assistance?
Output: [{"intent":"POLICY_QUERY","query":"Can I get roadside assistance?"}]

User: Will I get a replacement car?
Output: [{"intent":"POLICY_QUERY","query":"Will I get a replacement car?"}]

User: What happens if my car breaks down?
Output: [{"intent":"POLICY_QUERY","query":"What happens if my car breaks down?"}]

User: What should I do after an accident?
Output: [{"intent":"POLICY_QUERY","query":"What should I do after an accident?"}]

User: What benefits does my policy provide?
Output: [{"intent":"POLICY_QUERY","query":"What benefits does my policy provide?"}]

User: Am I covered for this accident?
Output: [{"intent":"POLICY_QUERY","query":"Am I covered for this accident?"}]
